...
**Nile** creates pictures of imaginary islands using nim. It includes:

- Efficient high-quality resampling of floating-point images. (`filter.nim`)
- Efficient computation of the signed distance fields. (`distance.nim`)
...
Alternatively, simply invoke `./tests/island.nim` directly since it has a shebang. This will enable
the release flag and create a very fast native executable.
